  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      api.get('/transactions').then(response => {
        const returnedBalance: Balance = response.data.balance;
        setBalance(returnedBalance);

        const returnedTransactions = response.data.transactions;
        const mappedTransactions = returnedTransactions.map((t: any) => {
          return {
            id: t.id,
            title: t.title,
            value: t.value,
